...
function MoviesCard(props) {
  return (
    <article className="movies-card">
      <button type="button" className="movies-card__save-btn">
        Сохранить
      </button>
      <button type="button" className="movies-card__saved-btn"></button>
      <button type="button" className="movies-card__delete-btn"></button>
